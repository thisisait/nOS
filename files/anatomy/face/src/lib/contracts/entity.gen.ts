...
export type LlmProvider = 'anthropic' | 'openclaw';
export const LLM_PROVIDERS = ['anthropic', 'openclaw'] as const;
...
export const MODEL_URI_PATTERN = /^(anthropic|openclaw)-[A-Za-z0-9._:/-]{1,96}$/;
