...
|---|---|---|
| `mariadb_version` | `11.8.9` | CVE-2026-49261 + CVE-2026-32710 + CVE-2026-3494 patched (REM-246 bumps 11.8.8 → 11.8.9 for six replication/perf-schema CVEs). Bumped from 11.4.10 which crashed on FK ALTER (BookStack migration #10) on Apple Silicon Docker Desktop. |
