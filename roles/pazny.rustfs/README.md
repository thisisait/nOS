...
Ansible role for deploying **RustFS** (S3-compatible object storage, Rust drop-in MinIO replacement) as a compose override fragment in the nOS `iiab` stack.

Part of [nOS](../../README.md) Wave 2.2 role extraction. Member of the `iiab-agents` group (`pazny.open_webui`, `pazny.uptime_kuma`, `pazny.vaultwarden`, **`pazny.rustfs`**).
