...
| [27](27-a-guard-that-named-two-causes-and-knew-neither.md) | The tofu destroy guard named both causes of a destroy and could distinguish neither | ~~a converge died on a removal the operator had authorised two days earlier~~ | **closed 2026-08-23** (attribute-then-refuse); verified against the failing plan |
