...
const DIMENSIONS = [
  ...
  },
  {
    ...
    prompt: [
      ...
      'docs/plans/nos-cortex-lang-wing-executor.md and PR-1 was deliberately HELD.',
      '',
      ...
      '  docs/plans/nos-cortex-lang.md is the spec; measure the code against it.',
      '- ent: and kg: are REFUSED today. docs/plans/cortex-self-core.md 8.1 says caller identity is',
  ...
  },
  {
    ...
    prompt: [
      ...
      '',
      'Establish:',
      '- What data-only concretely means, measured: docs/plans/cortex-self-core.md S5 says KEAP\'s server',
